  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: statusColor.withValues(alpha: 0.1), width: 1.5),
      ),
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: MTCTheme.primaryBlue.withValues(alpha: 0.31)),
            ),
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Icon(Icons.storage_rounded,
                    color: MTCTheme.primaryBlue, size: 12),
          ...
          Row(
            ...
            children: [
              const Icon(Icons.security_rounded,
                  color: MTCTheme.textSecondary, size: 14),
              const SizedBox(width: 8),
              Text('MTC National Database Verified',
                  style: GoogleFonts.outfit(
                      fontSize: 12,
                      color: MTCTheme.textSecondary,
                      fontWeight: FontWeight.w500)),
