        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.outfit(
                ...
                color: _input.isEmpty ? Colors.grey[300] : MTCTheme.textMain),
          ),
            ...
            Row(
              ...
              children: [
                const Icon(Icons.verified_user,
                    color: MTCTheme.safeGreen, size: 14),
                const SizedBox(width: 5),
                Text('VERIFYING WITH MTC REGISTRY...',
                    style: GoogleFonts.outfit(
                        fontSize: 10,
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            height: 80,
            decoration: const BoxDecoration(
                color: MTCTheme.safeGreen, shape: BoxShape.circle),
