...
class _BlacklistManagerState extends State<BlacklistManager> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive
              ? MTCTheme.mtcBlue.withValues(alpha: 0.1)
              : Colors.transparent,
        ...
        child: Row(
          children: [
            Icon(icon,
                color: isActive ? MTCTheme.mtcBlue : Colors.white24, size: 20),
  ...
  Widget _buildHeader() {
    return const Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Global Blacklist Manager',
            style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
        Text('Add or remove numbers from the network-wide shield',
  ...
  Widget _buildAddForm() {
    return Container(
      ...
      decoration: BoxDecoration(
          color: MTCTheme.primaryNavy, borderRadius: BorderRadius.circular(25)),
      child: Row(
        children: [
          Expanded(
            child: TextField(
                ...
                .map((item) => DataRow(cells: [
                      ...
                      DataCell(
                        Container(
                          ...
                          decoration: BoxDecoration(
                              color: MTCTheme.safeGreen.withValues(alpha: 0.1),
